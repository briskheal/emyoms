...
// 2. Fix Payment Modal
const paymentHeaderRegex = /<!-- HORIZONTAL VOUCHER INFO BAR -->[\s\S]*?<\/div>\s*<\/div>/;
const newPaymentHeader = `<!-- ULTRA-DENSE HORIZONTAL VOUCHER BAR -->
...
content = content.replace(paymentHeaderRegex, newPaymentHeader);
