...
const startIdx = serverJS.indexOf("app.post('/api/admin/expenses'");
const endStr = "// --- JOURNAL ENTRIES (JV) ---";
const endIdx = serverJS.indexOf(endStr);

if (startIdx !== -1 && endIdx !== -1) {
    serverJS = serverJS.substring(0, startIdx) + newCode + "\n\n" + serverJS.substring(endIdx);
