...
if (!content.includes('function autoPostInvoiceJV')) {
    const splitPoint = content.indexOf('async function autoPostPaymentJV');
    content = content.substring(0, splitPoint) + helpers + "\n" + content.substring(splitPoint);
}
...
console.log('Accounting hooks applied successfully');
